...
const FeaturedJobsCard = ({name, role, jobType, location, locationType, salary, salaryPer, vacancies, companyLogo}) => {
  return (
    <Link className='flex flex-col gap-2 w-[95%] lg:w-[40%] hover:shadow-xl outline outline-1 outline-gray-400 rounded-lg p-3'>
